...
<main class="main" id="top">
    <div class="container-fluid">
        ...
        <div class="content">
                    ...
                    <div class="card border h-100 w-100 overflow-hidden">
                        <div class="card-body px-5 position-relative">
                            <div class="d-flex justify-content-between align-items-center mb-5">
                                ...
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal_nueva_sala">Crear Nueva Sala</button>
                            </div>
                            <?php
            ...
            <div class="modal fade" id="modal_nueva_sala" tabindex="-1" aria-labelledby="verticallyCenteredModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <form method="post" action="acciones/sala_nueva_graba.php" enctype="multipart/form-data">
                            ...
                            <input name="unidad_id" type="hidden" value="<?php echo $unidad_id; ?>">
                            ...
                            <div class="modal-body">
                                    ...
                                    <fieldset class="mb-3">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="ordenador" name="ordenador" value="1" >
                                            <label class="form-check-label" for="ordenador">Ordenador</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="videoconferencia" name="videoconferencia" value="1" >
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="proyector" name="proyector" value="1" >
                                            <label class="form-check-label" for="proyector">Proyector</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="catering" name="catering" value="1" >
