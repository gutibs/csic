...
foreach($ci as $v){
    if( !is_null($v->imagen1)){ $carro[] = $v->imagen1; }
    if( !is_null($v->imagen2)){ $carro[] = $v->imagen2; }
    if( !is_null($v->imagen3)){ $carro[] = $v->imagen3; }
    if( !is_null($v->imagen4)){ $carro[] = $v->imagen4; }
    if( !is_null($v->imagen5)){ $carro[] = $v->imagen5; }
}
...
<main class="main">
    ...
    <section id="portfolio" class="portfolio section">
        ...
        <div class="container section-title" data-aos="fade-up">
            ...
            <h2>Las Salas</h2>
            <p>Algunas de las salas disponibles</p>
...
<?php
                    foreach ($carro as $image) {

                        preg_match('/sala_(\d+)/', $image, $matches);
                        $desiredNumber = $matches[1];


                                ?>
                        <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-books">
                        <div class="portfolio-content h-100">
                            <img src="static/imagenes/salas/<?php echo $image; ?>" class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <a href="static/imagenes/salas/<?php echo $image; ?>" data-gallery="portfolio-gallery-book" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                                <a href="sala_detalle.php?sala_id=<?php echo $desiredNumber; ?>" title="Ver" class="details-link"><i class="bi bi-link-45deg"></i></a>
                            </div>
                        </div>
...
?>
    ...
    <section id="contacto" class="contact section" >
        ...
        <div class="container section-title" data-aos="fade-up">
            ...
            <small>Si no tiene una cuenta creada, recibirá un mail de bienvenida apenas procesemos su solicitud y podamos darle una respuesta.</small>
        </div><!-- End Section Title -->

        <div class="container" data-aos="fade-up" data-aos-delay="100">
            <form action="contacto/solicitud.php" method="post" class="php-email-form" data-aos="fade-up" data-aos-delay="300">
